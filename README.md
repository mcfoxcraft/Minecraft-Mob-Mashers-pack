...
`knife`, `bone`, `peachone`, `magic_wand`, `fire_wand`, `runetracer`, the batch-2 evolutions, and batch 3 (#26): the bracelet bolts, the gun bullets and the bombs. Edit the table, run the script, and run `--check` in CI.
